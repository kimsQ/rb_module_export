...
<div id="infobox" class="p-3">
	...
	<tr>
		<td class="td1">제작사</td>
		<td>:</td>
		<td class="td2">(주)레드블럭</td>
	</tr>
	<tr>
		<td class="td1">이메일</td>
		<td>:</td>
		<td class="td2"><a href="mailto:break@redblock.co.kr">break@redblock.co.kr</a></td>
	</tr>
	<tr>
		<td class="td1">홈페이지</td>
		<td>:</td>
		<td class="td2">
			<a href="http://kimsq.com" target="_blank">kimsq.com</a>
		</td>
	</tr>
	<tr>
